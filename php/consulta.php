    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td><input class="dados-campo nao-clique" id="ID" type="text" placeholder="ID" value="'. $consulta['id_cadastro'] .'" readonly></td>
            </tr>
            <tr>
                <td class="width10percent"><label for="nome">NOME</label></td>
                <td><input class="dados-campo" id="nome" name="nome" type="text" placeholder="NOME" value="'. $consulta['nome_completo'] .'" readonly="true"></td>
            </tr>
            <tr>
                <td class="width10percent"><label for="senha">SENHA</label></td>
                <td><input class="dados-campo" id="senha" name="senha" type="text" placeholder="SENHA" value="'. $consulta['senha'] .'" readonly="true"></td>
            </tr>
            <tr>
                <td class="width10percent"><label for="email">EMAIL</label></td>
                <td><input class="dados-campo" id="email" name="email" type="email" placeholder="EMAIL" value="'. $consulta['email'] .'" readonly="true"></td>
            </tr>
            <tr>
                <td class="width10percent"><label for="telefone">TELEFONE</label></td>
                <td><input class="dados-campo" id="telefone" name="telefone" type="text" placeholder="TELEFONE" value="'. $consulta['telefone'] .'" readonly="true"></td>
            </tr>
            <tr>
            <td class="width10percent"><label for="sexo">SEXO</label></td>
                <td>
                    <select id="sexo" name="sexo" class="dados-campo" disabled>
                        ' . $sexo . '
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td><input class="dados-campo" id="data-de-nascimento" name="data-de-nascimento"" type="date" placeholder="DATA DE NASCIMENTO" value="'. $consulta['data_de_nascimento'] .'" readonly="true"></td>
            </tr>
            <tr>
                <td class="width10percent"><label for="ENDERECO">ENDEREÇO</label></td>
                <td><input class="dados-campo" id="endereco" name="endereco" type="text" placeholder="ENDEREÇO" value="'. $consulta['endereco'] .'" readonly="true"></td>
            </tr>
